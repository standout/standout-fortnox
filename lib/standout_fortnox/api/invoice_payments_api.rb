...
module StandoutFortnox
  class InvoicePaymentsApi
    ...
    def add_invoice_payment_with_http_info(body, opts = {})
      ...
      return_type = opts[:return_type] || 'InvoicePayment' 
    ...
    # @param [Hash] opts the optional parameters
    # @return [InvoicePayment]
    def update_invoice_payment(body, number, opts = {})
      data, _status_code, _headers = update_invoice_payment_with_http_info(body, number, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(InvoicePayment, Integer, Hash)>] InvoicePayment data, response status code and response headers
    def update_invoice_payment_with_http_info(body, number, opts = {})
      if @api_client.config.debugging
