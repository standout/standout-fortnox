...
module StandoutFortnox
  class InvoicesApi
    ...
    # Get all invoices
    # @param [Hash] opts the optional parameters
    # @option opts [] :filter Retrieves all invoices matching given filter
    # @option opts [] :offset 
    # @option opts [] :limit 
    # @option opts [] :sortby Which property to sort by, must be defined as sortable in documentation
    # @option opts [] :sortorder 
    # @option opts [] :page 
    # @option opts [] :lastmodified Retrieves all records since the provided timestamp
    # @option opts [] :fromdate Defines a selection based on a start date.
    # @option opts [] :todate Defines a selection based on an end date.
    # @option opts [] :costcenter Get only invoices inluding given value for CostCenter
    # @option opts [] :currency Get only invoices inluding given value for Currency
    # @option opts [] :customername Get only invoices inluding given value for CustomerName
    # @option opts [] :customernumber Get only invoices inluding given value for CustomerNumber
    # @option opts [] :documentnumber Get only invoices inluding given value for DocumentNumber
    # @option opts [] :externalinvoicereference1 Get only invoices inluding given value for ExternalInvoiceReference1
    # @option opts [] :externalinvoicereference2 Get only invoices inluding given value for ExternalInvoiceReference2
    # @option opts [] :ocr Get only invoices inluding given value for OCR
    # @option opts [] :ourreference Get only invoices inluding given value for OurReference
    # @option opts [] :project Get only invoices inluding given value for Project
    # @option opts [] :yourordernumber Get only invoices inluding given value for YourOrderNumber
    # @option opts [] :yourreference Get only invoices inluding given value for YourReference
    # @return [Invoices]
    ...
    # @param [Hash] opts the optional parameters
    # @return [Invoice]
    def update_invoice(body, document_number, opts = {})
      data, _status_code, _headers = update_invoice_with_http_info(body, document_number, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Invoice, Integer, Hash)>] Invoice data, response status code and response headers
    def update_invoice_with_http_info(body, document_number, opts = {})
      if @api_client.config.debugging
