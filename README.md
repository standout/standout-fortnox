...
```shell
gem install ./standout_fortnox-1.6.0.gem
```
(for development, run `gem install --dev ./standout_fortnox-1.6.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'standout_fortnox', '~> 1.6.0'
